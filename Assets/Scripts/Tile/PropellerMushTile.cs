...
[CreateAssetMenu(fileName = "PropellerMushTile", menuName = "ScriptableObjects/Tiles/PropellerMushTile", order = 13)]
public class PropellerMushTile : BreakableBrickTile {
