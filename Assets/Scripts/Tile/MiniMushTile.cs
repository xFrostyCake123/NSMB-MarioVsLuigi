...
[CreateAssetMenu(fileName = "MiniMushTile", menuName = "ScriptableObjects/Tiles/MiniMushTile", order = 14)]
public class MiniMushTile : BreakableBrickTile {
    ...
    public override bool Interact(MonoBehaviour interacter, InteractionDirection direction, Vector3 worldLocation) {
        ...
        if ((interacter is PlayerController) || (interacter is KoopaWalk koopa && koopa.previousHolder != null)) {
            ...
            spawnResult = player.state <= Enums.PowerupState.Small ? "Mushroom" : "MiniMushroom";
        }
