...
[CreateAssetMenu(fileName = "BlueShellTile", menuName = "ScriptableObjects/Tiles/BlueShellTile", order = 15)]
public class BlueShellTile : BreakableBrickTile {
    ...
    public override bool Interact(MonoBehaviour interacter, InteractionDirection direction, Vector3 worldLocation) {
        ...
        if ((interacter is PlayerController) || (interacter is KoopaWalk koopa && koopa.previousHolder != null)) {
            ...
            spawnResult = player.state <= Enums.PowerupState.Small ? "Mushroom" : "BlueShell";
        }
