...
[CreateAssetMenu(fileName = "CustomPowerupTile", menuName = "ScriptableObjects/Tiles/CustomPowerupTile", order = 10)]
public class CustomPowerupTile : BreakableBrickTile {
