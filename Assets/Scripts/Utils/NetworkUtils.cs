...
namespace NSMB.Utils {
    public static class NetworkUtils {
        ...
        private readonly static Hashtable _defaultRoomProperties = new() {
            ...
            [Enums.NetRoomProperties.StartingPowerup] = 1,
            [Enums.NetRoomProperties.GameStartReserve] = 1,
            [Enums.NetRoomProperties.RandomMap] = false,
            [Enums.NetRoomProperties.DrawTime] = false,
            [Enums.NetRoomProperties.NewPowerups] = true,
            [Enums.NetRoomProperties.FrostyPowerups] = true,
            [Enums.NetRoomProperties.DeathmatchGame] = false,
            ...
            [Enums.NetRoomProperties.NoMapCoins] = false,
            [Enums.NetRoomProperties.TenPlayersPowerups] = true,
            [Enums.NetRoomProperties.PropellerMush] = true,
            [Enums.NetRoomProperties.NsmbPowerups] = true,
            [Enums.NetRoomProperties.TemporaryPowerups] = true,
            [Enums.NetRoomProperties.BlueShellPowerup] = true,
            [Enums.NetRoomProperties.SuperAcornPowerup] = true,
            [Enums.NetRoomProperties.MiniMushroomPowerup] = true,
            [Enums.NetRoomProperties.FireFlowerPowerup] = true,
            [Enums.NetRoomProperties.StarmanPowerup] = true,
            [Enums.NetRoomProperties.CobaltStarPowerup] = true,
        ...
        Enums.NetRoomProperties.FrostyPowerups,
